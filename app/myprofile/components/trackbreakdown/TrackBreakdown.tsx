...
import { youtubeRevenue, spotifyRevenue } from "@/helper/revenueStats"
                        ...
                        <div key={track.trackId} className="bg-white rounded-lg shadow-lg p-6">
                            ...
                            <div className="flex gap-4 mb-4">
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-lg p-3 min-w-[120px] border border-emerald-200">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <p className="text-xs text-emerald-700 font-medium">Est. Revenue</p>
                                        </div>
                                        <p className="text-lg font-bold text-gray-900 mt-1">
                                            ${(((track.youtubeStreams * youtubeRevenue) + (track.spotifyStreams * spotifyRevenue)).toFixed(2))}
                                        </p>
                                    </div>
                                </div>
                            </div>
