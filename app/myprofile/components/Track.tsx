...
const Track = ({ track_name, artist_name, album_name, popularity, streams, release_date, image_url, user_track_id, youtube_streams, role, notes, onDelete }: TrackProps) => {
    ...
    const totalStreams = (streams + youtube_streams).toLocaleString() 
            ...
            <div className="flex flex-col flex-1 justify-between py-1">
                ...
                <div className="flex gap-6 mt-3">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-xs text-gray-400 uppercase tracking-wide">Total Streams</p>
                            <p className="text-sm font-semibold text-gray-800">{totalStreams}</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-3">
